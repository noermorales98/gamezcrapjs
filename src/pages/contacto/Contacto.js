            ...
            <div className="flex">
                <div className="flex-1 text-white">
                    ...
                    <div className="contact__redes">
                        <a href='https://www.facebook.com' rel="noreferrer" target="_blank" className="contacto__icon facebook">
                            <i className="contacto__icon-svg">
                        ...
                        <a href='https://www.whatsapp.com' rel="noreferrer" target="_blank" className="contacto__icon whatsapp">
                            <i className="contacto__icon-svg">
                        ...
                        <a href='https://www.twitter.com' rel="noreferrer" target="_blank" className="contacto__icon twitter">
                            <i className="contacto__icon-svg">
                ...
                <div className="contact__container text-white">
                    <div className="contact__form">
                        <h3>Contáctanos</h3>
                        <form ref={form} onSubmit={sendEmail} className="contact__form-formik">
                        <input
                                        type="name"
                                        name="name"
                                        id='name'
