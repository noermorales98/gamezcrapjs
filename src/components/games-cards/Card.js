...
function Card({ games }) {
    ...
    return (
        <div
          ...
          style={{ background: `url(${games.thumb})`, backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' }}
        ...
        >
            <div className='card__info'>
                ...
                <div className='d-flex gap-1'>
                    ...
                    {showButton && (
                        <div className='add-favorite' onClick={ () => {
                            const token = JSON.parse(window.localStorage.getItem('tokenKey'))

                            setFavorite(token, games.gameID, games.title, games.thumb)
                        }}>
